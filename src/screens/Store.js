    ...
    <div>
      ...
      <div className="flex items-center justify-center">
        <input
          placeholder="Search ..."
          ref={myInput}
          className="mb-20 mt-20 w-6/12 rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-2 ring-inset ring-black placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-lime-400 sm:text-sm sm:leading-6"
        />
      </div>
      <div className="flex items-center justify-center flex-wrap mb-12">
